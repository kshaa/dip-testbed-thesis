...
\begin{abstract}
    ...
    Also this work encompasses process modelling of such a platform,
    complications encountered in development and the solutions and architectures
    used for solving these complications.  

    More specifically this work describes a soft realtime system for remote
    interaction between platform users and available digital hardware
    development boards i.e. remote board programming, remote prototype firmware
    testing and information exchange. In addition some extra features for better
    user experience in the platform are implemented and described.  

    A platform was developed in the scope of this work which consists of a
    server acting as a communication proxy, a client i.e. a command line tool
    for connecting the user to the server and hardware, an agent i.e. a command
    line tool for connecting the hardware to the server and users. Additionally
    this platform was hosted in a public cloud platform. A test laboratory i.e.
    an FPGA testbed was created in the author's home and connected to the public
    cloud platform.
